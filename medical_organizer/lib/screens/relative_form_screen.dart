...
class _RelativeFormScreenState extends State<RelativeFormScreen> {
  ...
  Future<void> _pickDate() async {
    ...
    if (d != null) {
      setState(() => _birthDate = '${d.year}-${d.month.toString().padLeft(2,'0')}-${d.day.toString().padLeft(2,'0')}');
    }
  }
  ...
  Future<void> _submit() async {
    ...
    try {
      await ApiService.createRelative({
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Добавить родственника'),
          ...
          children: [
            ...
            DropdownButtonFormField<String>(
              ...
              items: _relations.map((r) => DropdownMenuItem(
                value: r,
                child: Text(Relative.relationLabel(r)),
              )).toList(),
            ...
            InkWell(
              ...
              child: InputDecorator(
                ...
                child: Text(_birthDate ?? 'Не указана', style: TextStyle(
